...
public class DuplicateClassTest extends TestCase {
    ...
    public void testNPEDuplicatedClass() throws IOException {
        ...
        JavacTask ct = (JavacTask)tool.getTask(null, null, null, global.Utils.asParameters("-source", version, "-Xjcov", "-XDshould-stop.at=GENERATE"), null, Arrays.asList(new MyFileObject(code)));
